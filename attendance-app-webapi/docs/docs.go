    ...
    "definitions": {
        ...
        "models.UserDetail": {
            ...
            "properties": {
                ...
                "userID": {
                    "description": "The 'unique' tag enforces the one-to-one relationship at the database level.",
                    "type": "integer"
                }
            }
        },
